export default function ProblemGrid() {
  return (
    <div className="bg-[var(--neutral\/white,white)] content-stretch flex flex-col gap-[48px] items-center p-[80px] relative size-full" data-node-id="6:2" data-name="Modern Clinics Overloaded Section">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-center not-italic overflow-clip relative shrink-0 text-center" data-node-id="6:3" data-name="Frame">
        <p className="font-['Inter:Bold'] font-bold leading-[48px] relative shrink-0 text-[40px] text-[color:var(--text\/primary,#1a201c)] tracking-[-0.8px] whitespace-nowrap" data-node-id="6:4">
          Modern clinics are overloaded.
        </p>
        <div className="font-['Inter:Regular'] font-normal leading-[0] relative shrink-0 text-[17px] text-[color:var(--text\/secondary,#555f58)] w-[720px]" data-node-id="6:5">
      ...
      <div className="content-stretch flex gap-[24px] items-start overflow-clip relative shrink-0" data-node-id="6:6" data-name="Problem Cards Grid">
        <div className="bg-[var(--neutral\/bg-light,#f5f7f3)] border border-[var(--neutral\/border-light,#f0f2eb)] border-solid content-stretch flex flex-col gap-[20px] items-start overflow-clip px-[28px] py-[32px] relative rounded-[var(--radius\/xl,24px)] shrink-0 w-[290px]" data-node-id="6:7" data-name="Repetitive Patient Intake">
          ...
          <p className="[word-break:break-word] font-['Inter:Regular'] font-normal h-[88px] leading-[22px] not-italic relative shrink-0 text-[14px] text-[color:var(--text\/secondary,#555f58)] w-[234px]" data-node-id="6:11">
            Patients repeatedly share the same history, symptoms, and previous reports, wasting valuable consultation time.
          </p>
        </div>
        <div className="bg-[var(--neutral\/bg-light,#f5f7f3)] border border-[var(--neutral\/border-light,#f0f2eb)] border-solid content-stretch flex flex-col gap-[20px] items-start overflow-clip px-[28px] py-[32px] relative rounded-[var(--radius\/xl,24px)] shrink-0 w-[290px]" data-node-id="6:12" data-name="Documentation Burden">
          ...
          <p className="[word-break:break-word] font-['Inter:Regular'] font-normal h-[88px] leading-[22px] not-italic relative shrink-0 text-[14px] text-[color:var(--text\/secondary,#555f58)] w-[234px]" data-node-id="6:16">
            Doctors spend too much time typing clinical notes instead of actively engaging with patients.
          </p>
        </div>
        <div className="bg-[var(--neutral\/bg-light,#f5f7f3)] border border-[var(--neutral\/border-light,#f0f2eb)] border-solid content-stretch flex flex-col gap-[20px] items-start overflow-clip px-[28px] py-[32px] relative rounded-[var(--radius\/xl,24px)] shrink-0 w-[290px]" data-node-id="6:17" data-name="Weak Post-Care">
          ...
          <p className="[word-break:break-word] font-['Inter:Regular'] font-normal h-[88px] leading-[22px] not-italic relative shrink-0 text-[14px] text-[color:var(--text\/secondary,#555f58)] w-[234px]" data-node-id="6:21">
            Patients often miss medications, ignore warning signs, or delay follow-up visits after leaving the clinic.
          </p>
        </div>
        <div className="bg-[var(--neutral\/bg-light,#f5f7f3)] border border-[var(--neutral\/border-light,#f0f2eb)] border-solid content-stretch flex flex-col gap-[20px] items-start overflow-clip px-[28px] py-[32px] relative rounded-[var(--radius\/xl,24px)] shrink-0 w-[290px]" data-node-id="6:22" data-name="Lost Clinical Wisdom">
          ...
          <p className="[word-break:break-word] font-['Inter:Regular'] font-normal h-[88px] leading-[22px] not-italic relative shrink-0 text-[14px] text-[color:var(--text\/secondary,#555f58)] w-[234px]" data-node-id="6:26">
            Years of clinical reasoning and successful treatment patterns remain buried in unstructured records.
          </p>
        </div>
      </div>
    </div>
